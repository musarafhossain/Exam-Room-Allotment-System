  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <title>Exam Duty Finder | Allotment System</title>
        <meta name="description" content="Find your examination duty assignment quickly and easily. Enter your name to see your allotted duty shift, slot and date." />
      </head>
      <body>

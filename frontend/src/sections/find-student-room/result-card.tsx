      ...
      >
        <Stack spacing={4}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 2.5, md: 3 }, flexDirection: { xs: 'column', sm: 'row' }, textAlign: { xs: 'center', sm: 'left' } }}>
            ...
            <Box>
              <Typography variant="h4" fontWeight={800} sx={{ letterSpacing: -1, fontSize: { xs: '1.75rem', md: '2.5rem' } }}>Allotment Confirmed</Typography>
              <Typography color="text.secondary" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>We successfully located your examination room.</Typography>
            </Box>
          </Box>
          ...
          <Grid container spacing={4}>
            <ResultItem icon={<RoomIcon />} label="Room Number" value={result.roomNo} highlight />
            ...
            <ResultItem icon={<SubjectIcon />} label="Subject" value={result.subject || 'N/A'} />
            <ResultItem icon={<PaperIcon />} label="Paper" value={result.paper || 'N/A'} />
            <ResultItem 
              icon={<TimeIcon />} 
              label="Exam Time" 
          ...
          <Box sx={{ mt: 2, p: 3, bgcolor: 'info.lighter', borderRadius: 3, display: 'flex', alignItems: 'flex-start', gap: 2 }}>
            <Typography variant="body2" color="info.main" fontWeight={600}>
              Note: Please arrive at the room at least 20 minutes before the exam starts. Carry your ID card.
            </Typography>
          </Box>
        </Stack>
      </Paper>
